...
View and set default application associations on macOS — file extensions, UTIs and URL schemes. A modern replacement for [RCDefaultApp](https://www.rubicode.com/Software/RCDefaultApp/), [SwiftDefaultApps](https://github.com/Lord-Kamina/SwiftDefaultApps) and [duti](https://github.com/moretension/duti), all of which are unmaintained and built on APIs Apple has since deprecated or removed.
